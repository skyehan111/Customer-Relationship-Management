                        ...
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>联系人名称：</TD>
                                    <TD>
                                        <s:textfield name="lkm_name" class="textbox" cssStyle="WIDTH: 80px"
                                                     id="sChannel2" theme="simple"></s:textfield>
                            ...
                            <TABLE id=grid
                                ...
                                <s:iterator value="list">
                                    <TR
                                        ...
                                        <TD>
                                            <a href="${pageContext.request.contextPath }/LinkManAction_edit?lkm_id=<s:property value="lkm_id"/>">修改</a>
                                            &nbsp;&nbsp;
